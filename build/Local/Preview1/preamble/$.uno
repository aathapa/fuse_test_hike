...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.12"), 12124)}, "/Users/aayush/Desktop/hike/hike.unoproj", GetBundle, new string[] { })
{
